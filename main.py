    ...
    if userNums == authKeyNums and userNums == secretKeyNums:
        ...
        for i in range(userNums):
            try:
                ...
                instance.topHome()
                time.sleep(2)
                logger.info('Checking for monthly tickets...')
                instance.buyMonthlyTickets()
                time.sleep(2)
                logger.info('Checking for Blue Apples...')
                instance.buyBlueApple()
                time.sleep(2)
                logger.info('Checking Present Box for Tickets and SQ...')
                instance.receive_presents()
                time.sleep(2)
